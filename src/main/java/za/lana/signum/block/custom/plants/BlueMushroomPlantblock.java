...
public class BlueMushroomPlantblock extends PlantBlock implements Fertilizable {
    protected static final VoxelShape SHAPE = Block.createCuboidShape(5.0, 0.0, 5.0, 11.0, 6.0, 11.0);
    private final RegistryKey<ConfiguredFeature<?, ?>> featureKey = ModConfiguredFeatures.HUGE_TOXIC_MUSHROOM_KEY;

    public BlueMushroomPlantblock(Settings settings, RegistryKey<ConfiguredFeature<?, ?>> hugeToxicMushroomKey) {
        super(settings);
    }
    @Override
