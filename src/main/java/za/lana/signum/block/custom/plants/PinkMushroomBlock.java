...
public class PinkMushroomBlock
extends Block {
    ...
    public PinkMushroomBlock(Settings settings) {
        super(settings);
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        if (PinkMushroomBlock.isFaceFullSquare(blockState.getCollisionShape(world, blockPos), Direction.UP)) {
            return;
        }
