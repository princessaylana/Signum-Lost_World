...
public class ModBlockEntities {
    ...
    public static BlockEntityType<ZedVendingBlockEntity> ZED_VENDING_BLOCK_ENTITY;
   // public static BlockEntityType<ExampleBlockEntity> EXAMPLE_BLOCK_ENTITY;
    ...
    public static void registerBlockEntities(){
        ...
        ZED_VENDING_BLOCK_ENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                new Identifier(Signum.MOD_ID, "zed_vending_block_entity"),
                FabricBlockEntityTypeBuilder.create(ZedVendingBlockEntity::new,
                        ModBlocks.ZEDVENDING_BLOCK).build(null));
