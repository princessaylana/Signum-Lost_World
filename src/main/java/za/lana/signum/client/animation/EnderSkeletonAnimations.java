...
public class EnderSkeletonAnimations {



    public static final Animation ENDERSKELETON_WALK = Animation.Builder.create(1f).looping()
    ...
    public static final Animation ENDERSKELETON_IDLE = Animation.Builder.create(1f).looping()
            ...
            .addBoneAnimation("rightLeg",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            ...
                            new Keyframe(1f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR))).build();
    public static final Animation ENDERSKELETON_ATTACK = Animation.Builder.create(0.5f).looping()
            .addBoneAnimation("rightArm",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR),
