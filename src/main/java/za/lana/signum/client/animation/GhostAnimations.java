...
public class GhostAnimations {
    ...
    public static final Animation GHOST_MOVE = Animation.Builder.create(2f).looping()
    ...
    public static final Animation GHOST_IDLE = Animation.Builder.create(2f).looping()
            ...
            .addBoneAnimation("head",
                    new Transformation(Transformation.Targets.SCALE,
                            ...
                            new Keyframe(2f, AnimationHelper.createScalingVector(1f, 1f, 1f),
                                    Transformation.Interpolations.LINEAR))).build();
    public static final Animation GHOST_MELEE = Animation.Builder.create(2f).looping()
            .addBoneAnimation("mainBody",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR),
            ...
            .addBoneAnimation("leftArm",
                    new Transformation(Transformation.Targets.SCALE,
                            ...
                            new Keyframe(0.5f, AnimationHelper.createScalingVector(1f, 1f, 1f),
                                    Transformation.Interpolations.LINEAR))).build();
    public static final Animation GHOST_TELEPORT = Animation.Builder.create(2f).looping()
            .addBoneAnimation("mainBody",
                    new Transformation(Transformation.Targets.SCALE,
                            new Keyframe(0f, AnimationHelper.createScalingVector(1f, 1f, 1f),
                                    Transformation.Interpolations.LINEAR),
