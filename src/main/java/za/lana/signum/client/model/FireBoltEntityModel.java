...
public class FireBoltEntityModel extends SinglePartEntityModel<FireBoltEntity> {
	...
	@Override
	public void setAngles(FireBoltEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
