...
public class PoisonBoltEntityModel extends SinglePartEntityModel<PoisonBoltEntity> {

	private final ModelPart bolt;
	public PoisonBoltEntityModel(ModelPart root) {
	...
	@Override
	public void setAngles(PoisonBoltEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
