...
public class ShockBoltEntityModel extends SinglePartEntityModel<ShockBoltEntity> {

	private final ModelPart bolt;
	public ShockBoltEntityModel(ModelPart root) {
	...
	@Override
	public void setAngles(ShockBoltEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
