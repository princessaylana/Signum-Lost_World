...
public class SpellBoltEntityModel extends SinglePartEntityModel<SpellBoltEntity> {

	private final ModelPart bolt;
	public SpellBoltEntityModel(ModelPart root) {
	...
	@Override
	public void setAngles(SpellBoltEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
