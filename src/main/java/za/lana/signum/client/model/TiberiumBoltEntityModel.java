...
public class TiberiumBoltEntityModel extends SinglePartEntityModel<TiberiumBoltEntity> {

	private final ModelPart bolt;
	public TiberiumBoltEntityModel(ModelPart root) {
	...
	@Override
	public void setAngles(TiberiumBoltEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
