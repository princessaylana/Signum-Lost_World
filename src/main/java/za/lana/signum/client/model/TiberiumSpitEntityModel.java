...
public class TiberiumSpitEntityModel extends SinglePartEntityModel<TiberiumSpitEntity> {

	private final ModelPart bolt;
	public TiberiumSpitEntityModel(ModelPart root) {
	...
	@Override
	public void setAngles(TiberiumSpitEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
