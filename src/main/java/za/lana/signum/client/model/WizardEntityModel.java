...
public class WizardEntityModel <T extends WizardEntity> extends SinglePartEntityModel<T> implements ModelWithArms{
	...
	@Override
	public void setAngles(WizardEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
