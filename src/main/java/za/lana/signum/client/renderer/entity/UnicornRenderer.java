...
private final Identifier TEXTURE = new Identifier(Signum.MOD_ID, "textures/entity/animal/unicorn_white1.png");

    public UnicornRenderer(EntityRendererFactory.Context context) {
        super(context, new UnicornEntityModel<>(context.getPart(ModModelLayers.UNICORN)), 0.6f);
    }
