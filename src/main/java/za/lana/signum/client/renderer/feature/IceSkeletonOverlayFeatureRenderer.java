...
public class IceSkeletonOverlayFeatureRenderer<T extends IceSkeletonEntity>
extends FeatureRenderer<T, IceSkeletonModel<T>> {
    private final EntityModel<T> model;

    public IceSkeletonOverlayFeatureRenderer(FeatureRendererContext<T,IceSkeletonModel<T>> context, EntityModelLoader loader) {
        super(context);
        this.model = new IceSkeletonModel<>(loader.getModelPart(ModModelLayers.ICESKELETON));
    }
