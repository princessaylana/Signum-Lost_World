...
public class DeathEffect extends StatusEffect {
    ...
    public void applyInstantEffect(@Nullable Entity source, @Nullable Entity attacker, LivingEntity target, int amplifier, double proximity) {
        if (this == ModEffects.DEATH_EFFECT) {
            ...
            if(target instanceof PlayerEntity || target instanceof EnderDragonEntity || target instanceof WitherEntity || target instanceof TorturedSoulEntity || target instanceof GhostEntity){
