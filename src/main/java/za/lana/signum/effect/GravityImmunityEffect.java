...
public class GravityImmunityEffect extends StatusEffect {

    protected GravityImmunityEffect(StatusEffectCategory category, int color) {
    ...
    public void applyUpdateEffect(LivingEntity entity, int amplifier) {
        ...
        entity.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOW_FALLING, 100, 2), entity);
        entity.addStatusEffect(new StatusEffectInstance(StatusEffects.JUMP_BOOST, 100, 25), entity);

        if (effect.getEffectType() == ModEffects.GRAVITY_EFFECT || !entity.isOnGround()) {
            entity.heal(1.0f);
