...
public class TransmuteImmunityEffect extends StatusEffect {

    protected TransmuteImmunityEffect(StatusEffectCategory category, int color) {
    ...
    public void applyUpdateEffect(LivingEntity entity, int amplifier) {
        ...
        if (effect.getEffectType() == ModEffects.TRANSMUTE_EFFECT) {
            entity.addStatusEffect(new StatusEffectInstance(StatusEffects.LUCK, 100, 1), entity);
            entity.heal(1.0f);
