...
public class CursedWolfAttackGoal extends MeleeAttackGoal {
    private final CursedWolfEntity entity;
    private int attackDelay = 20;
    private int ticksUntilNextAttack = 20;
    private boolean shouldCountTillNextAttack = false;
    //unicorn attack 1sec 20ticks

    public CursedWolfAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((CursedWolfEntity) mob);
    }
    @Override
    public void start() {
        super.start();
